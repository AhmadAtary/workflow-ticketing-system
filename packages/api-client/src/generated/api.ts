...
export const getCompleteTaskStepUrl = (taskId: string) => {
  return `/api/v1/tasks/${taskId}/complete-step`;
};
...
export const getSendBackTaskUrl = (taskId: string) => {
  return `/api/v1/tasks/${taskId}/send-back`;
};
...
export const getHoldTaskUrl = (taskId: string) => {
  return `/api/v1/tasks/${taskId}/hold`;
};
...
export const getListTaskCommentsQueryKey = (taskId: string) => {
  return [`/api/v1/tasks/${taskId}/comments`] as const;
};
...
export const getListEmailTemplatesQueryKey = () => {
  return [`/api/v1/email-templates`] as const;
};
...
export const getGetEmailTemplateUrl = (templateId: string) => {
  return `/api/v1/email-templates/${templateId}`;
};
...
export const getGetDashboardSummaryQueryKey = () => {
  return [`/api/v1/reports/dashboard-summary`] as const;
};
...
export const getGetTaskStatsUrl = () => {
  return `/api/v1/reports/task-stats`;
};
...
export const getGetTaskStatsQueryKey = () => {
  return [`/api/v1/reports/task-stats`] as const;
};
...
export const getGetTeamPerformanceUrl = (params?: GetTeamPerformanceParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/reports/team-performance?${stringifiedParams}`
...
export const getGetWorkflowBottlenecksUrl = () => {
  return `/api/v1/reports/workflow-bottlenecks`;
};
...
export const getGetWorkflowBottlenecksQueryKey = () => {
  return [`/api/v1/reports/workflow-bottlenecks`] as const;
};
...
export const getGetActivityFeedUrl = (params?: GetActivityFeedParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/reports/activity-feed?${stringifiedParams}`
    : `/api/v1/reports/activity-feed`;
};
